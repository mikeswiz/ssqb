...
def getdatapath():
    ...
    if __ssqb_data_directory__.startswith('/'):
        pathname = __ssqb_data_directory__
    else:
        pathname = os.path.dirname(__file__) + '/' + __ssqb_data_directory__
